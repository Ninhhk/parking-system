            ...
            <div className="mb-6">
                <div className="relative w-80">
                    ...
                    <input
                        ...
                        placeholder="Search by ID, session, method, amount..."
                        className="block w-full pl-10 pr-10 py-2 border border-slate-200 rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                    />
                </div>
            </div>
